...
const NewBookModal = ({ isCreateBook, setIsCreateBook }) => {
    ...
    const handleAddBook = e => {
        ...
        axios
            .post(booksApi, newBook)
            .then(res => console.log(`User with name ${newBook.title} created successfully. `, res))
            .catch(err => console.error(`Error creating user with name ${newBook.title}: `, err));
    }
                ...
                <div className="row py-0 pt-5 mt-4 mx-sm-5 px-sm-5">
                    ...
                    <div className="col-sm-6">
                        ...
                        <p>
                            ...
                            <input type="text" className="text-center text-md-start ps-sm-2 rounded-4" id="create-image-path-input" name="imagePath" maxLength="255" required/>
                        </p>
                    </div>
                </div>
